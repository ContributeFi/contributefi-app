      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex w-full items-center gap-4 min-[834px]:w-auto">
          ...
          <div className="flex w-full gap-4 rounded-[8px] bg-[#F7F9FD] p-2">
            ...
            <Button
              onClick={() => handleChangeBurstView("joined")}
              variant="outline"
              className={`flex-1 cursor-pointer rounded-[2px] border-none ${burstView === "joined" ? "bg-white text-[#2F0FD1]" : "bg-[#F7F9FD] text-[#525866]"} p-2 text-[15px] hover:bg-white hover:text-[#2F0FD1]`}
            >
              Joined
            </Button>
        ...
        <Button className="w-full cursor-pointer rounded-md bg-[#2F0FD1] px-8 py-5 text-[16px] font-[300] hover:bg-[#2F0FD1]/70 hover:text-white min-[834px]:w-auto">
          Create New Burst
        </Button>
      </div>
